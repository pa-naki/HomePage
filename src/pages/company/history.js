      ...
      <Wrapper>
        ...
        >
          <table>
            <tr>
              <td>1958</td>
              <td className="nowrap">昭和33</td>
              <td>
                大阪合同(株）（現オー・ジー(株）が大阪工場、東京工場、西条工場を分離し、資本金500万円で大和化学工業株式会社を設立
              </td>
              <td>
                <StaticImage
                  src="../../images/company_history/image1.jpg"
                  alt="大阪合同大阪工場"
                  layout="fixed"
                  placeholder="blurred"
                />
            ...
            <tr>
              <td>1959</td>
              <td className="nowrap">昭和34</td>
              <td>本社工場で蛍光漂白剤「マルチファー」の製造開始</td>
            </tr>
            <tr>
              <td>1962</td>
              <td className="nowrap">昭和37</td>
              <td>東京工場で紙力増強剤「ソルダイン」発売</td>
            </tr>
            <tr>
              <td>1966</td>
              <td className="nowrap">昭和41</td>
              <td>大阪工場、染色用「キャリヤー」製造開始</td>
            </tr>
            <tr>
              <td>1968</td>
              <td className="nowrap">昭和43</td>
              <td>硫酸化油の製造開始</td>
            </tr>
            <tr>
              <td>1969</td>
              <td className="nowrap">昭和44</td>
              <td>本社事務所新築竣工</td>
            </tr>
            <tr>
              <td>1970</td>
              <td className="nowrap">昭和45</td>
              <td>防炎剤「フランO・T」 防炎協会の検定に合格</td>
            </tr>
            <tr>
              <td>1976</td>
              <td className="nowrap">昭和51</td>
              <td>「ソルダイン」販売、年間1,500トン突破</td>
            </tr>
            <tr>
              <td>1980</td>
              <td className="nowrap">昭和55</td>
              <td>大阪工場、研究棟落成式挙行、本社社屋増築工事竣工</td>
              <td>
                <StaticImage
                  src="../../images/company_history/image2.jpg"
                  alt="新築になった大阪工場研究棟"
                  layout="fixed"
                  placeholder="blurred"
                />
            ...
            <tr>
              ...
              <td>
                <StaticImage
                  src="../../images/company_history/image3.jpg"
                  alt="新築になった東京工場研究棟"
                  layout="fixed"
                  placeholder="blurred"
                />
            ...
            <tr>
              <td>1984</td>
              <td className="nowrap">昭和60</td>
              <td>大手家電メーカー掃除機用ゴミパック防ダニ剤を発売</td>
            </tr>
            <tr>
              <td>1986</td>
              <td className="nowrap">昭和61</td>
              <td>塩素堅牢度向上剤「アクロリンシリーズ」を発売</td>
              <td>
                <StaticImage
                  src="../../images/company_history/image4.jpg"
                  alt="大阪工場（1980年代半ば）"
                  layout="fixed"
                  placeholder="blurred"
                />
            ...
            <tr>
              <td>1988</td>
              <td className="nowrap">昭和63</td>
              <td>PVA 用剥離剤「コートサイザーNP シリーズ」を発売</td>
            </tr>
            <tr>
              <td>1989</td>
              <td className="nowrap">平成元</td>
              <td>
            ...
            <tr>
              <td>1995</td>
              <td className="nowrap">平成7</td>
              <td>タバコ消臭剤「ザオバスーパー類」を発売</td>
            </tr>
            <tr>
              <td>1996</td>
              <td className="nowrap">平成8</td>
              <td>
            ...
            <tr>
              <td>1999</td>
              <td className="nowrap">平成11</td>
              <td>加齢臭用消臭剤「ノネノンシリーズ」を発売</td>
            </tr>
            <tr>
              <td>2000</td>
              <td className="nowrap">平成12</td>
              <td>大阪工場、防炎剤フランについてのISO9002 認証取得</td>
            </tr>
            <tr>
              <td>2001</td>
              <td className="nowrap">平成13</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <StaticImage
                  src="../../images/company_history/image5.jpg"
                  alt="中国無錫・大精細化工有限公司"
                  layout="fixed"
                  placeholder="blurred"
                />
            ...
            <tr>
              <td>2005</td>
              <td className="nowrap">平成17</td>
              <td>家庭紙用接着剤「セルグルーシリーズ」を発売</td>
            </tr>
            <tr>
              <td>2009</td>
              <td className="nowrap">平成21</td>
              <td>評価技術センター設立、JNLAに登録</td>
            </tr>
            <tr>
              <td>2010</td>
              <td className="nowrap">平成22</td>
              <td>
                東京支社開設
                <br />
                片面撥水加工剤「パナペースト類」を発売
            ...
            <tr>
              <td>2011</td>
              <td className="nowrap">平成23</td>
              <td>非HBCDタイプ防炎加工剤「フランEMシリーズ」を発売</td>
            </tr>
            <tr>
              <td>2012</td>
              <td className="nowrap">平成24</td>
              <td>
                残香性保持増強剤「フレグセル」を発売
                <br />
